    ...
    return (
        <AppLayout title="Dashboard" breadcrumbs={BREADCRUMBS}>
            ...
            <div className="rounded-lg border border-border-subtle bg-surface-primary p-8 text-center">
                <h2 className="text-xl font-semibold text-text-strong">PHC Nexus</h2>
                <p className="mt-2 text-base text-text-muted">Platforma běží. Milestone 0 — Foundation je hotový.</p>
