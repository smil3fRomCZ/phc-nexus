...
import { Info, LayoutGrid, Table2, Layers, Timer, GanttChart, CheckSquare, BookOpen, Dices } from 'lucide-react';

interface ProjectTabsProps {
    projectId: string;
    active: 'overview' | 'board' | 'table' | 'epics' | 'time' | 'gantt' | 'approvals' | 'wiki' | 'estimation';
}
